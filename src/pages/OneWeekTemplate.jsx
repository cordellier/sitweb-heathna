...
const SiteEn1Semaine = () => {
  ...
  useEffect(() => {
    ...
    // Déclencher l'animation après un court délai pour s'assurer que le composant est monté
      ...
      <div className="content-wrapper">
        <div className="content-section">
          ...
          <p className="description animate-element">
            Vous n'avez pas encore de site internet, ou ce dernier ne reflète pas votre professionnalisme ? La technique, le
            budget ou le manque de temps vous empêchent de passer à l'action ? Ne laissez pas ces obstacles freiner votre
            activité! Choisissez un thème et en 1 semaine, vous aurez un site professionnel et efficace, prêt à booster votre
            visibilité.
          </p>
          <div className="buttons animate-element">
            <button className="savoir-plus">SAVOIR +</button>
            <button className="choisir-theme">CHOISIR MON THÈME</button>
          </div>
        </div>
